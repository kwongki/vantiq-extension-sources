...
public class SenseNebulaConnectorMain {

    static final Logger log = LoggerFactory.getLogger(SenseNebulaConnectorMain.class);
    static List<SenseNebulaConnectorCore> sources;
     ...
     */
    private static void startSources(List<SenseNebulaConnectorCore> sources) {
        for (SenseNebulaConnectorCore source : sources) {
     ...
     */
    static List<SenseNebulaConnectorCore> createSources(Properties config) {
        ...
        for (String sourceName : sourceNames) {
            ...
            SenseNebulaConnectorCore source;
            source = new SenseNebulaConnectorCore(sourceName, authToken, targetVantiqServer);
            sources.add(source);
        }
