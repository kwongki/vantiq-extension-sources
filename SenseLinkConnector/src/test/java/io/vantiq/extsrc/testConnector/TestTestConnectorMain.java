...
public class TestTestConnectorMain {
    ...
    public void tearDown() {
        List<SenseLinkConnectorCore> sources = SenseLinkConnectorMain.sources;
        System.setSecurityManager(null);
        if (sources != null) {
            for (SenseLinkConnectorCore s : sources) {
                s.stop();
            }
            SenseLinkConnectorMain.sources = null;
        }
    }
    ...
    public void testConfigs() {
        ...
        try {
            ...
            SenseLinkConnectorMain.createSources(props);
        ...
        SenseLinkConnectorMain.createSources(props);
        assert SenseLinkConnectorMain.targetVantiqServer.equals("url");
        SenseLinkConnectorCore s = SenseLinkConnectorMain.sources.get(0);
        ...
        SenseLinkConnectorMain.createSources(props);
        assert SenseLinkConnectorMain.targetVantiqServer.equals(targetServer);
        SenseLinkConnectorCore s1 = SenseLinkConnectorMain.sources.get(0);
        SenseLinkConnectorCore s2 = SenseLinkConnectorMain.sources.get(1);
