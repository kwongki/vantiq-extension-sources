...
public class SenseLinkConnectorMain {

    static final Logger log = LoggerFactory.getLogger(SenseLinkConnectorMain.class);
    static List<SenseLinkConnectorCore> sources;
     ...
     */
    private static void startSources(List<SenseLinkConnectorCore> sources) {
        for (SenseLinkConnectorCore source : sources) {
     ...
     */
    static List<SenseLinkConnectorCore> createSources(Properties config) {
        ...
        for (String sourceName : sourceNames) {
            ...
            SenseLinkConnectorCore source;
            source = new SenseLinkConnectorCore(sourceName, authToken, targetVantiqServer);
            sources.add(source);
        }
